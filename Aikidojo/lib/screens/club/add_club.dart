...
import 'package:stage/Entities/Club.dart';
...
class add_club extends StatefulWidget {
  static String routeName = "/addclub";

  @override
  State<StatefulWidget> createState() => InitState();
}

class InitState extends State<add_club> {
  ...
  Future<Club> addstage(List<Club>club) async {
